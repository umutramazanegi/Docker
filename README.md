...
- docker image pull ozgurozturknet/app1 ->  ozgurozturknet appisini docker’a çektik. Bu imageden bir container oluşturacağız. 
...
- `docker container rm <ContainerID>` -> ID'si verilen container'ı siler
  ...
  - docker container -a  >>> docker ps -a aynı şeyler
